...
module.exports.encrypt = (text, masterkey) => {
...
module.exports.decrypt = (encdata, masterkey) => {
  // base64 decoding
...
module.exports.encryptstream = (buffer, masterkey) => {
  var cipher = _crypto.createCipher(algorithm, masterkey)
  var crypted = Buffer.concat([cipher.update(buffer), cipher.final()]);
  return crypted;
}

module.exports.decryptstream = (buffer, masterkey) => {
  var decipher = _crypto.createDecipher(algorithm, masterkey)
